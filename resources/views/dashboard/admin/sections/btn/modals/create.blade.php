<div class="modal fade" id="createSection" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-dark text-white">
                <h5 class="modal-title text-white" id="exampleModalLabel">اضافه قسم جديد</h5>
                ...
                <form action="{{route( 'sections.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-1 form-group">
                        ...
                        <select name="status" class="form-control">
                            <option selected disabled> اختر حاله القسم...</option>
